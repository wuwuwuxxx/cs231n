...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W2'] = np.random.normal(scale=weight_scale, size=(num_filters*input_dim[2]**2/4, hidden_dim))
  ...
  def loss(self, X, y=None):
    ...
    a, grads['W3'], grads['b3'] = affine_backward(dx, scores_cache)
    grads['W3'] += self.reg * W3
    b, grads['W2'], grads['b2'] = affine_relu_backward(a, hid_cache)
    grads['W2'] += self.reg * W2
    _, grads['W1'], grads['b1'] = conv_relu_pool_backward(b, conv_cache)
